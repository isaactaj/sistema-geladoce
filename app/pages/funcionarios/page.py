...
class PaginaFuncionarios(ctk.CTkFrame):
    ...
    def _criar_tabela(self):
        ...
        # ✅ corrigido: agora conecta as duas scrollbars
    ...
    def _salvar(self):
        ...
        if self.id_selecionado is not None:
            ...
            self._limpar_form()
            self._atualizar_tabela()
            CTkMessagebox(title="Sucesso", message="Funcionário atualizado com sucesso", icon="check")
            return
        ...
        self._limpar_form()
        self._atualizar_tabela()
        CTkMessagebox(title="Sucesso", message="Funcionário adicionado com sucesso", icon="check")
